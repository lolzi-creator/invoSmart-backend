...
export declare const getInvoices: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getInvoice: (req: Request, res: Response, next: import("express").NextFunction) => void;
...
//# sourceMappingURL=invoiceControllerOld.d.ts.map